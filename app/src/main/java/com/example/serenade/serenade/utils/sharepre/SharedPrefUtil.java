package com.example.serenade.serenade.utils.sharepre;
...
public class SharedPrefUtil {
    ...
    private static SharedPrefUtil prefsInstance;
    ...
    private SharedPrefUtil(@NonNull Context context) {
    ...
    /**
     * @param context
     * @return Returns a 'SharedPrefUtil' instance
     */
    public static SharedPrefUtil with(@NonNull Context context) {
        if (prefsInstance == null) {
            prefsInstance = new SharedPrefUtil(context);
        }
